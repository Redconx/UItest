...
exports.findElementsOfType = findElementsOfType;
var _react = require("react");
function findElementsOfType(types, node) {
  if (!node || !( /*#__PURE__*/(0, _react.isValidElement)(node) || Array.isArray(node))) {
    // There's nothing to recurse on, and this is not the droid we're looking for
    return [];
  }
  if ( /*#__PURE__*/(0, _react.isValidElement)(node) && types.includes(node.type)) {
