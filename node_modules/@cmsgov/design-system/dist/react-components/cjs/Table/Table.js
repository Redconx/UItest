 ...
 */function isTableCaption(child) {
  if (!child || ! /*#__PURE__*/(0, _react.isValidElement)(child)) {
    return false;
  }
...
const Table = _ref => {
  ...
  const [scrollActive, setScrollActive] = (0, _react.useState)(false);
  ...
  const renderedChildren = _react.Children.map(children, child => {
