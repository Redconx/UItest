...
export type DateFieldProps = BaseDateFieldProps & Omit<UseLabelPropsProps & UseHintProps & UseInlineErrorProps, 'id' | 'inversed'>;
/**
 * For information about how and when to use this component,
 * [refer to its full documentation page](https://design.cms.gov/components/date-field/multi-input-date-field/).
 */
export declare function MultiInputDateField(props: DateFieldProps): React.ReactElement;
