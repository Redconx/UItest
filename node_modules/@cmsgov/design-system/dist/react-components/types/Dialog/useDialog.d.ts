 ...
 */
export declare function useDialog<ReturnType = any>(renderDialog: (renderProps: UseDialogRenderProps<ReturnType>) => React.ReactElement): {
    dialog: import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
    openDialog: () => Promise<ReturnType>;
};
