...
export declare const DrawerContext: import("react").Context<any>;
/**
 ...
 */
export declare const DrawerManager: (props: any) => import("react/jsx-runtime").JSX.Element;
export declare const useDrawerManager: () => {
    openDrawer: () => any;
    closeDrawer: () => any;
    toggleDrawer: () => any;
