...
class Mask extends _compat.PureComponent {
  constructor(props) {
    super(props);
  ...
  componentDidUpdate(prevProps) {
    ...
    const prevField = _compat.Children.only(prevProps.children);
    const prevFieldProps = (0, _compat.isValidElement)(prevField) ? prevField.props : {};
  ...
  render() {
    ...
    const field = this.field();
    const modifiedTextField = (0, _compat.cloneElement)(field, {
