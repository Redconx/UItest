...
exports.default = exports.ZIP_MASK = exports.SSN_MASK_OBFUSCATED = exports.SSN_MASK = exports.RE_ZIP = exports.RE_SSN = exports.RE_PHONE = exports.RE_DATE = exports.RE_CURRENCY = exports.PHONE_MASK = exports.DATE_MASK = exports.CURRENCY_MASK = void 0;
exports.useLabelMask = useLabelMask;
...
const RE_PHONE = /^\(?(\d{1,3})?\)?[\s.-]?(\d{1,3})?[\s.-]?(\d{1,4})?/;
exports.RE_PHONE = RE_PHONE;
const RE_SSN = /([*\d]{1,3})[\s.-]?([*\d]{1,2})?[\s.-]?([\d{1,4}]+)?/;
exports.RE_SSN = RE_SSN;
const RE_ZIP = /(\d{1,5})/;
exports.RE_ZIP = RE_ZIP;
const RE_CURRENCY = /\$?[\d,.-]*/;
 ...
 */
exports.RE_CURRENCY = RE_CURRENCY;
 ...
 */
const DATE_MASK = makeMask(RE_DATE, 'MM/DD/YYYY', match => {
...
const PHONE_MASK = makeMask(RE_PHONE, '###-###-####', match => {
 ...
 */
exports.PHONE_MASK = PHONE_MASK;
const ZIP_MASK = makeMask(RE_ZIP, '#####', match => {
  return match[1];
});
 ...
 */
exports.ZIP_MASK = ZIP_MASK;
const SSN_MASK = makeMask(RE_SSN, '###-##-####', match => {
  /**
...
const SSN_MASK_OBFUSCATED = (rawInput, valueOnly) => {
 ...
 */
exports.SSN_MASK_OBFUSCATED = SSN_MASK_OBFUSCATED;
const CURRENCY_MASK = makeMask(RE_CURRENCY, '$', match => {
...
function useLabelMask(maskFn, originalInputProps) {
  ...
  const [currentValue, setCurrentValue] = (0, _compat.useState)(value);
  (0, _compat.useEffect)(() => {
  ...
  const inputProps = {
    ...
    type: 'text',
    inputMode: 'numeric',
    'aria-describedby': (0, _mergeIds.default)(originalInputProps['aria-describedby'], labelMaskId)
  };
  ...
  return {
    labelMask: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      className: "ds-c-label-mask",
      id: labelMaskId,
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
        className: (0, _classnames.default)(focused && 'ds-u-visibility--screen-reader'),
        children: currentMask
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
        className: (0, _classnames.default)(!focused && 'ds-u-display--none'),
        "aria-hidden": "true",
        children: currentMask
      })]
    }),
