...
const Dropdown = props => {
  ...
  const reactStatelyItems = optionsAndGroups.map((item, index) => {
    if ((0, _utils.isOptGroup)(item)) {
      ...
      return /*#__PURE__*/(0, _compat.createElement)(_reactAria.Section, {
        ...extraAttrs,
        key: `group-${index}`,
        title: label
  ...
  const [internalValueState, setInternalValueState] = (0, _compat.useState)(fallbackValue);
  ...
  const onBlur = (0, _compat.useCallback)(
  ...
  const triggerRef = (0, _compat.useRef)();
