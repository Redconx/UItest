...
const Autocomplete = props => {
  ...
  const inputRef = (0, _compat.useRef)();
  const listBoxRef = (0, _compat.useRef)();
  const wrapperRef = (0, _compat.useRef)();
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    ...
    ref: wrapperRef,
    children: [(0, _compat.cloneElement)(textField, textFieldProps), (state.isOpen && reactStatelyItems.length > 0 || state.isFocused && statusMessage) && /*#__PURE__*/(0, _jsxRuntime.jsx)(_DropdownMenu.default, {
