...
const IdleTimeout = _ref => {
  ...
  const [checkStatusTime, setCheckStatusTime] = (0, _compat.useState)(null);
  const [showWarning, setShowWarning] = (0, _compat.useState)(false);
  const [timeInWarning, setTimeInWarning] = (0, _compat.useState)(Math.ceil(timeToTimeout - timeToWarning));
  ...
  const resetTimeouts = (0, _compat.useCallback)(() => {
    clearTimeouts();
    setTimeoutCookies();
  }, []);
