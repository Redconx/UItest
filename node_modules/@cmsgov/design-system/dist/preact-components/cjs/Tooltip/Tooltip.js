 ...
 */
const Tooltip = props => {
  const popper = (0, _compat.useRef)(null);
  const contentId = (0, _useId.default)('tooltip-trigger--', props.id);
  const triggerElement = (0, _compat.useRef)(null);
  const tooltipElement = (0, _compat.useRef)(null);
  ...
  const [active, setActive] = (0, _compat.useState)(false);
  const [isHover, setIsHover] = (0, _compat.useState)(false);
  const [isMobile, setIsMobile] = (0, _compat.useState)(false);
  const prevActiveStateVar = (0, _usePrevious.default)(active);
  ...
  (0, _compat.useEffect)(() => {
    ...
    popper.current = (0, _core.createPopper)(triggerElement.current, tooltipElement.current, {
  ...
  const renderTrigger = props => {
    ...
    const triggerClasses = (0, _classnames.default)('ds-c-tooltip__trigger', className, {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(TriggerComponent, {
  ...
  const renderContent = props => {
    ...
    const tooltipContent = /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      id: contentId,
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
        ...
        children: [contentHeading || showCloseButton ? /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          className: (0, _classnames.default)('ds-c-tooltip__header', {
            'ds-c-tooltip__header--right': !contentHeading
          }),
          children: [contentHeading, showCloseButton && /*#__PURE__*/(0, _jsxRuntime.jsx)(_Button.Button, {
            variation: "ghost",
            size: "small",
      ...
      }), !dialog && /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_CSSTransition.default, {
      ...
      children: dialog ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_focusTrapReact.default, {
        active: active,
        focusTrapOptions: {
