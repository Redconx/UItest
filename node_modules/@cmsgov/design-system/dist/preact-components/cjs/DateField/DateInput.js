...
class DateInput extends _compat.PureComponent {
  constructor(props) {
    super(props);
    this.handleBlur = this.handleBlur.bind(this);
    this.handleChange = this.handleChange.bind(this);
    this.id = props.id ?? (0, _uniqueId.default)('date-input--');
  }
  formatDate() {
  ...
  renderField(type, maxLength) {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_TextField.default, {
      ...
      label: this.props[`${type}Label`] ?? (0, _i18n.t)(`dateField.${type}Label`),
      name: this.props[`${type}Name`],
      maxLength: maxLength,
      fieldClassName: (0, _classnames.default)(`ds-c-field--${type}`, {
  ...
  render() {
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [this.renderField('month', 2), /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
        className: "ds-c-datefield__separator",
        children: "/"
      }), this.renderField('day', 2), /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
        className: "ds-c-datefield__separator",
        children: "/"
