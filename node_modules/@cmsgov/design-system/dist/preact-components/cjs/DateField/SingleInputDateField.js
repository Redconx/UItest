...
const SingleInputDateField = props => {
  ...
  const [pickerVisible, setPickerVisible] = (0, _compat.useState)(false);
  const id = (0, _useId.default)('date-field--', props.id);
  const isControlled = remainingProps.value !== undefined;
  const [internalValueState, setInternalValueState] = (0, _compat.useState)(remainingProps.defaultValue);
  ...
  const dayPickerRef = (0, _compat.useRef)();
  const calendarButtonRef = (0, _compat.useRef)();
