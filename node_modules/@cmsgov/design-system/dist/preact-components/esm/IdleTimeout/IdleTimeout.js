...
const defaultMessageFormatter = timeTilTimeout => {
  const unitOfTime = timeTilTimeout === 1 ? t('idleTimeoutDialog.min') : t('idleTimeoutDialog.mins');
  return /*#__PURE__*/_jsxs("p", {
    children: [t('idleTimeoutDialog.messageLine1'), /*#__PURE__*/_jsx("br", {}), t('idleTimeoutDialog.messageLine2'), /*#__PURE__*/_jsxs("strong", {
      children: [timeTilTimeout, " ", unitOfTime]
    }), ".", /*#__PURE__*/_jsx("br", {}), /*#__PURE__*/_jsx("br", {}), t('idleTimeoutDialog.continueSessionMessage')]
  });
};
...
export const IdleTimeout = _ref => {
  ...
  const [checkStatusTime, setCheckStatusTime] = useState(null);
  const [showWarning, setShowWarning] = useState(false);
  const [timeInWarning, setTimeInWarning] = useState(Math.ceil(timeToTimeout - timeToWarning));
  ...
  return /*#__PURE__*/_jsx(IdleTimeoutDialog, {
